...
<html>
<head>
	<title>Informe del Sistema de Gestión de Recibos Electrónicos</title>
</head>
<body>
<div align="center">
<h2>Informe de Gestión de Recibos Electrónicos - Año {{ $año}}</h2>
<label><strong>Usuario que genero informe: </strong>{{$user->nombres}} {{$user->apellidos}}</label><br>
<label><strong>Fecha y hora del informe: </strong>{{$fecha_hora}}</label>
