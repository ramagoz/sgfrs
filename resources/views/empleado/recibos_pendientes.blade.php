...
{{-- Dentro de section va el contenido de la vista--}}
	...
	<form action="/empleado/recibos_firmados/" method="POST">
	{{csrf_field()}}
	...
	@foreach ($recibos as $recibo)
		...
		<tr>
			...
			<td><a class="btn btn-primary" href="{{ url('/empleado/ver_recibo_pendiente_firma_empleado/'.$recibo->id_recibo ) }}" role="button">VER</a></td>
